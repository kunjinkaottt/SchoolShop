...
<!--        <el-breadcrumb separator-class="el-icon-arrow-right">&lt;!&ndash; 面包屑 &ndash;&gt;
            ...
            <el-breadcrumb-item>营业的店铺</el-breadcrumb-item>
        </el-breadcrumb>-->
        <!--    搜索-->
        <div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                pageSize: 5,//默认每页5条数据
                total: 0,
                ShopABusinessList1: []   //最后面的1表示 查询出店铺状态为1(营业)的店铺
            }
        },
        created() {
            this.load()
        ...
        methods: {
            load() {
                    request.get("/ShopManage/" + this.currentPage + "/" + this.pageSize + "/" + 1 + "/" + this.search).then(res => {
                        this.total = res.data.total
                        this.ShopABusinessList1 = res.data.records
